...
// solution 
// first loop on the nested arrays and get sum of each one 
// then sum the total 
//  return multiply the total * 20
function stairsIn20(s){
   return s.map((m) => m.reduce((acc,curr)=> acc + curr ,0)).reduce((a,b)=> a+b,0) * 20
  }
  console.log(stairsIn20([[1,2],[1,2]]));